...
export const loginUser = (fields, role) => async (dispatch) => {
    ...
    try {
        const result = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/${role}Login`, fields, {
...
export const registerUser = (fields, role) => async (dispatch) => {
    ...
    try {
        const result = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/${role}Reg`, fields, {
            headers: { 'Content-Type': 'application/json' },
        });
...
export const addStuff = (fields, address) => async (dispatch) => {
    ...
    try {
        const result = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/${address}Create`, fields, {
            headers: { 'Content-Type': 'application/json' },
        });
